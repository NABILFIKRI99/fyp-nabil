...
if(count($_POST)>0) {
mysqli_query($con,"UPDATE inventory set items_id='" . $_POST['items_id'] . "', first_name='" . $_POST['first_name'] . "', last_name='" . $_POST['last_name'] . "', city_name='" . $_POST['city_name'] . "' ,email='" . $_POST['email'] . "' WHERE userid='" . $_POST['userid'] . "'");
$message = "Record Modified Successfully";
}
$result = mysqli_query($con,"SELECT * FROM inventory WHERE items_id='" . $_GET['items_id'] . "'");
